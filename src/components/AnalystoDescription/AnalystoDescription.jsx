...
function AnalystoDescription() {
  return (
    <div
id="Analysto"
className="analysto-section d-flex align-items-center justify-content-center p-4 mx-3 container-fluid"
>
<div className="analysto-description col-md-4 p-2">
  <h1 className='text-center'>Who is Analysto ?</h1>
  <p className="analysto-p text-center">
...
export default AnalystoDescription;
